package com.example.augistest;

import static com.example.augistest.MainActivity.hasInternet;
...
public class DistrictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(hasInternet(getApplicationContext())) {
            ...
            Toast.makeText(getApplicationContext(), "Reikalingas internetas", Toast.LENGTH_SHORT).show();
        }
    }

    private void getDistrictData() { // indiškas API https://www.covid19india.org
